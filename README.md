...
Таблицы.
Техника(Наименование, Производитель, количество, Дата выпуска, Цена)
Консультант(ФИО, Отдел, Телефон, Паспорт)
Продажа(Консультант, Техника, Дата,)
...
* Запросы
Для каждого производителя вывести суммарное количество проданных товаров, сумму 
...
Получить данные о продажах товаров за последний год.
